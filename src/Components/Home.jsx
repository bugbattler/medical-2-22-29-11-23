...
import ketan_more from "../images/Ketan More.jpg";
...
const Home = () => {
  ...
  return (
    <>
      <div className="hero-padding-hero-top"></div>
          ...
          <div className="col-lg-6 slider-content ">
            <div className="slider-sec ">
              <h1 className="sub-title">
                Welcome to Institute of Medical Coding Classes
              </h1>
              ...
              <p className=" mt-5 p-2" style={{ fontSize: 17 }}>
                At IMC, we are your compass on the path to a successful career in
                medical coding. Our mission is to provide you with the knowledge
                and skills required to excel in this dynamic field of healthcare.
              </p>
              <Link
              ...
              <div className="col-lg-6">
                <div className="home-about">
                  <h5 className="sub-title">
                    Discover Why IMC Is Your Ideal Choice
                  </h5>
                  <ul>
                    <li>
                      <p className="details">
                        <strong> Expert Faculty:</strong> Our instructors are
                        industry experts with years of practical experience.
                        They are committed to not only providing you with
                        knowledge but also mentoring you on your journey to
                        success.
                      </p>
                    </li>
                    <li>
                      <p className="details">
                        <strong> Practical Curriculum:</strong> Our curriculum
                        emphasizes hands-on learning and real world application.
                        We want you to be not just exam-ready but workplace
                        ready
                      </p>
                    </li>
                    <li>
                      <p className="details">
                        <strong> Certification Focus:</strong> Our programs are
                        designed to prepare you for industry recognized
                        certifications like the Certified Professional Coder
                        (CPC) and Certified Coding Specialist (CCS), boosting
                        your career prospects.
                      </p>
                    </li>
                    <li>
                      <p className="details">
                        <strong> Flexible Learning Options:</strong> Whether you
                        prefer in-person classes in our modern facilities or the
                        flexibility of online learning, we offer options
                        tailored to your needs
                      </p>
                    </li>
                    <li>
                      <p className="details">
                        <strong> Career Support:</strong> We're more than just
                        an educational institution; we're your partner in career
                        development. Benefit from job placement assistance,
              ...
              <div className="">
                <div className="cource-list">
                  ...
                  <div className="cource-description">
                    ...
                    <p>
                      Ideal for beginners, covering CPT, ICD-10, and HCPCS Level
                      II coding. Duration: 1.5 month.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="">
                <div className="cource-list">
                  ...
                  <div className="cource-description">
                    ...
                    <p>
                      {" "}
                      Self-paced online courses for remote learners. Duration: 2
                      weeks.
                    </p>
                  </div>
                </div>
              ...
              <div className="">
                <div className="cource-list">
                  ...
                  <div className="cource-description">
                    ...
                    <p>
                      {" "}
                      For experienced coders looking to update and enhance their
                      skills. Duration: 2 - 3 weeks.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="">
                <div className="cource-list">
                  ...
                  <div className="cource-description">
                    ...
                    <p>
                      {" "}
                      Focus on inpatient, outpatient, or specialty coding.
                      Duration: 2 - 2.5 week each.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="">
                <div className="cource-list">
                  ...
                  <div className="cource-description">
                    ...
                    <p>
                      For those with prior experience, exploring advanced coding
                      guidelines and software tools. Duration: 3 - 4 weeks.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="">
                <div className="cource-list">
                  ...
                  <div className="cource-description">
                    ...
                    <p>
                      {" "}
                      Stay updated with evolving coding guidelines and trends
                      through our ongoing professional development courses for 1
                      - 2 weeks
                    </p>
                  </div>
                </div>
              ...
              <div className="">
                <div className="cource-list">
                  ...
                  <div className="cource-description">
                    ...
                    <p>
                      {" "}
                      Tailored for CPC, CCS, and other certifications, including
                      practice exams. Duration: 3 months.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="container">
              <div className="download-app-wrapper mt-n6">
                <div className="section-title section-title-white">
                  ...
                  <h2 className="main-title pb-5">Your Journey Begins Here</h2>
                  <p className="text-white journey">
                    Whether you're entering the world of medical coding or
                    advancing your existing skills, Institute of Medical Coding
                    offers a diverse range of programs tailored to your needs.
                    Join us and begin an exciting journey toward a prosperous and
                    fulfilling career in medical coding.
                  </p>
                </div>
                {/* <img
                ...
                <div className="row">
                  <div className="col-md-4 mb-3">
                    <div className="single-testimonial">
                      ...
                      <div className="testimonial-content">
                        <p>
                          "Thankful for the rewarding path of becoming a medical
                          student, each hurdle brought me closer to impacting
                  ...
                  <div className="col-md-4 ">
                    <div className="single-testimonial mb-4">
                      ...
                      <div className="testimonial-content">
                        <p>
                          "Delving into the complexities of the human body, one
                          textbook at a time. #MedicalStudentLife
                          #EmbarkingOnTheHealingJourney"
                        </p>
                        <h4 className="name">Ketan More</h4>
                        {/* <span className="designation">Product Designer, USA</span> */}
                      </div>
                    </div>
                  </div>
        ...
        <div className="row ptb-30">
          <div className="section section-padding download-section">
            ...
            <div className="container">
              <div className="download-app-wrapper mt-n6">
                <div className="section-title section-title-white">
                  <h2 className="main-title pb-5">Get Started Today</h2>
                  <p className="text-white journey">
                    Ready to embark on this exciting journey? Contact us now to
                    explore our programs, enrollment procedures, and how we can
                    support your aspirations in the realm of medical coding. We're
                    thrilled to be your partner in success.
                  </p>
                </div>
                <img
                  className="shape-1 animation-right"
